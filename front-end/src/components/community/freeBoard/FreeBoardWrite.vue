        ...
        <div class="container " data-aos="fade-left" data-aos-delay="200">
          <div class="row">
              ...
              <table class="tableWrite">
                ...
                <thead>
                  <tr style="font-size: 14px;  ">
                    ...
                    <td>
                      <select required class="search" v-model="selectFbCategory" name="count" data-title="선택"
                  ...
                  <tr data-v-224097a6="" style="font-size: 14px;">
                    ...
                    <td>
                      <input type="tbTitle" v-model="fbTitle" v-validate="'required'" id="fbTitle" name="fbTitle"
                        placeholder="제목을 입력하세요" class="category"
                        :class="{ 'is-invalid': submitted && errors.has('fbTitle') }"
                        style=" font-size: 12px; width: 80%; margin: 10px; ">
                      <div v-if="submitted && errors.has('fbTitle')" class="invalid-feedback">{{
                        errors.first('fbTitle')
                      }}</div>
                    </td>
                  </tr>
                  ...
                  <tr data-v-224097a6="" style="font-size: 14px;">
                    ...
                    <td style="width: 80%;">
                      <input type="text" placeholder="내용을 입력하세요" class="category" v-model="fbContent"
                  ...
                  <tr data-v-224097a6="" style="font-size: 14px;">
                    ...
                    <td>
                      <input type="text" placeholder="#태그를 입력하세요" class="category" v-model="fbTag"
                        style=" font-size: 12px; width: 80%; margin: 10px; ">
                    </td>
                  </tr>
            ...
            <div class="button">
              ...
              <button class="uploadButton" style=" font-size: 12px;" @click.prevent="upload"><svg
