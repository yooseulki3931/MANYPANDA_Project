              ...
              <table class="tableWrite">
                ...
                <thead>
                  <tr style="font-size: 14px;  ">
                    ...
                    <td>
                      <select required class="search" v-model="selectBbCategory" name="count" data-title="선택"
                  ...
                  <tr data-v-224097a6="" style="font-size: 14px;">
                    ...
                    <td>
                      <input type="tbTitle" v-model="bbTitle" v-validate="'required'" id="bbTitle" name="bbTitle"
                      ...
                      <div v-if="submitted && errors.has('bbTitle')" class="invalid-feedback">{{
                        errors.first('bbTitle')
                      }}</div>
                    </td>
                  </tr>
                  ...
                  <tr data-v-224097a6="" style="font-size: 14px;">
                    ...
                    <td style="width: 80%;">
                      <input type="text" placeholder="내용을 입력하세요" class="category" v-model="bbContent"
                  ...
                  <tr data-v-224097a6="" style="font-size: 14px;">
                    ...
                    <td>
                      <input type="text" placeholder="#태그를 입력하세요" class="category" v-model="bbTag"
                        style=" font-size: 12px; width: 80%; margin: 10px; ">
                    </td>
                  </tr>
