              ...
              <table class="tableWrite">
                ...
                <thead>
                  <tr style="font-size: 14px;  ">
                    ...
                    <td>
                      <select required class="search" v-model="selectLbCategory" name="count" data-title="선택"
                  ...
                  <tr data-v-224097a6="" style="font-size: 14px;">
                    ...
                    <td>
                      <input type="tbTitle" v-model="lbTitle" v-validate="'required'" id="lbTitle" name="lbTitle"
                      ...
                      <div v-if="submitted && errors.has('lbTitle')" class="invalid-feedback">{{
                        errors.first('lbTitle')
                      }}</div>
                    </td>
                  </tr>
